...
if($edit ==0)
{
	...
	$dbresult1 = $db->Execute($query1, array($date_created,$date_created,$client, $libelle_commande,$fournisseur,$prix_total, $statut_commande,$paiement, $mode_paiement, $remarques, $commande_number, $user_validation));
