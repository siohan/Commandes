...
$items_paiement = array("Non payée"=>"Non payée", "Payée"=>"Payée", "Payée et déstockée"=>"Payée et déstockée","Refusée"=>"Refusée", "Reçue"=>"Reçue","Dotations"=>"Dotations");
$items_mode_paiement = array("Aucun"=>"Aucun","Chèque"=>"Chèque", "Espèces"=>"Espèces", "Autres"=>"Autres");



$liste_categories = array("BOIS"=>"BOIS","REVETEMENTS"=>"REVETEMENTS","BALLES"=>"BALLES","TEXTILES"=>"TEXTILES","AUTRES"=>"AUTRES");
