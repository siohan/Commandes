...
#
	...
	#
		$insert_sql = "INSERT INTO ".cms_db_prefix()."module_commandes_fournisseurs (`nom_fournisseur`, `description`, `actif`, `ordre`) VALUES ( ?, ?, ?, ?)";
		$db->execute($insert_sql, array( 'WACK SPORT', 'Le catalogue WACK', '1', '20'));
		$db->execute($insert_sql, array( 'BUTTERFLY','Le catalogue BUTTER', '1', '10'));
#Indexes
...
$this->SetPreference('new_status_subject', 'Ta commande a changé de statut');
//permissions
$this->CreatePermission('Use Commandes','Utiliser le module Commandes');
// crééer un nouvel événement
